...
module SpinaThemePlain
  module Generators
    ...
    class SharedViewsGenerator < Rails::Generators::Base #:nodoc:
      ...
      desc "Copies Spina CMS views to your application."
      hide!
    ...
    #   include ViewPathTemplates
    #   source_root File.expand_path("../../../../app/views", __FILE__)
    #   desc "Copies Spina CMS theme mail erb views to your application."
    #   hide!
    ...
    #   desc "Copies Spina CMS theme mail markerb views to your application."
    #   hide!
